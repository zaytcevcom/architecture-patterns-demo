...
final readonly class AudioAlbumGetByUserIdFetcher
{
     ...
     * @throws Exception
     */
    public function fetch(AudioAlbumGetByUserIdQuery $query): ResultCountItems
    {
        ...
        $sqlQuery = $queryBuilder
            ...
            ->innerJoin('a', 'audios_albums_owners', 'au', 'au.album_id = a.id')
