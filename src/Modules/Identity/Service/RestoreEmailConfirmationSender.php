...
final readonly class RestoreEmailConfirmationSender
{
    ...
    {
        $html = $this->twig->render('email/restore/confirm.html.twig', [
            'code' => $code,
            'year' => date('Y'),
        ]);
        ...
        $message = (new MimeEmail())
            ...
            ->subject($this->translator->trans('email.restore.confirm.subject', [], 'identity'))
            ->to($email->getValue())
            ->html($html);
