...
final readonly class PostCommentedHandler
{
    ...
    public function handle(PostCommentedCommand $command): void
    {
        ...
        $text = $post->getMessage() ?? '🖼 Фотография'; // todo

        $category   = NotifierCategory::POST_COMMENTED;
