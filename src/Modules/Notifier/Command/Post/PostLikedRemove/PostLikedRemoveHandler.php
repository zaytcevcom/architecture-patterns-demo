...
final readonly class PostLikedRemoveHandler
{
    ...
    public function handle(PostLikedRemoveCommand $command): void
    {
        $category = NotifierCategory::PUSH_REMOVE;

        $data = [
            'id' => $this->notifierHelper->getId(NotifierCategory::POST_LIKED, $command->likeId),
        ];
