...
namespace App\Modules\Union\Query\Place\GetByUserId;
...
final readonly class PlaceGetByUserIdFetcher
{
     ...
     * @throws Exception
     */
    public function fetch(PlaceGetByUserIdQuery $query): ResultCountItems
    {
