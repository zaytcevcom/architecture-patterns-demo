...
namespace App\Modules\Union\Query\UnionCategory\Community\BySphere;
...
final readonly class UnionCategoryCommunityBySphereFetcher
{
     ...
     * @throws Exception
     */
    public function fetch(UnionCategoryCommunityBySphereQuery $query): ResultCountItems
    {
