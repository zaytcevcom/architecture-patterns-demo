...
namespace App\Modules\Union\Query\UnionSphere\Event;
...
final readonly class UnionSphereEventFetcher
{
     ...
     * @throws Exception
     */
    public function fetch(UnionSphereEventQuery $query): ResultCountItems
    {
