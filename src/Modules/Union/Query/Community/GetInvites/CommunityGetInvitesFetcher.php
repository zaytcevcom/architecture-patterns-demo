...
final readonly class CommunityGetInvitesFetcher
{
     ...
     * @throws Exception
     */
    public function fetch(CommunityGetInvitesQuery $query): ResultCountItems
    {
        $roles = [
        ...
        $sqlQuery = $queryBuilder
            ...
            ->innerJoin('uu', 'unions', 'union', 'uu.union_id = union.id')
            ->where('uu.union_id = :unionId')
            ->andWhere('union.type = :unionType')
            ...
            ->setParameter('unionType', Union::typeCommunity());
