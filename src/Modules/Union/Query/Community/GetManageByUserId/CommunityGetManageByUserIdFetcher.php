...
namespace App\Modules\Union\Query\Community\GetManageByUserId;
...
final readonly class CommunityGetManageByUserIdFetcher
{
     ...
     * @throws Exception
     */
    public function fetch(CommunityGetManageByUserIdQuery $query): ResultCountItems
    {
        $roles = [
