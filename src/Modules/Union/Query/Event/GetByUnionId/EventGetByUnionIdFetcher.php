...
namespace App\Modules\Union\Query\Event\GetByUnionId;
...
final readonly class EventGetByUnionIdFetcher
{
     ...
     * @throws Exception
     */
    public function fetch(EventGetByUnionIdQuery $query): ResultCountItems
    {
