...
namespace App\Modules\Union\Query\Event\GetByUserId;
...
final readonly class EventGetByUserIdFetcher
{
     ...
     * @throws Exception
     */
    public function fetch(EventGetByUserIdQuery $query): ResultCountItems
    {
