...
use App\Modules\Audio\Query\AudioPlaylist\GetByUserId\AudioPlaylistGetByUserIdFetcher;
use App\Modules\Audio\Query\AudioPlaylist\GetByUserId\AudioPlaylistGetByUserIdQuery;
...
#[OA\Get(
    path: '/users/{id}/audio-playlists',
    description: 'Получение списка плейлистов пользователя',
...
final readonly class UserGetAudioPlaylistsAction implements RequestHandlerInterface
{
    public function __construct(
        private Denormalizer $denormalizer,
        private AudioPlaylistGetByUserIdFetcher $fetcher,
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $query = $this->denormalizer->denormalizeQuery(
            ...
            AudioPlaylistGetByUserIdQuery::class
        );
