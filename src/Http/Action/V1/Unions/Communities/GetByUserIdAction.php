...
use App\Modules\Union\Query\Community\GetByUserId\CommunityGetByUserIdFetcher;
use App\Modules\Union\Query\Community\GetByUserId\CommunityGetByUserIdQuery;
...
#[OA\Get(
    ...
    description: 'Получение списка сообществ пользователя',
    summary: 'Получение списка сообществ пользователя',
    security: [['bearerAuth' => '{}']],
    tags: ['Unions (User)']
)]
#[OA\Parameter(
...
final readonly class GetByUserIdAction implements RequestHandlerInterface
{
    public function __construct(
        ...
        private CommunityGetByUserIdFetcher $fetcher,
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $query = $this->denormalizer->denormalizeQuery(
            ...
            CommunityGetByUserIdQuery::class
        );
