...
use App\Modules\Union\Query\Place\GetByUserId\PlaceGetByUserIdFetcher;
use App\Modules\Union\Query\Place\GetByUserId\PlaceGetByUserIdQuery;
...
#[OA\Get(
    ...
    description: 'Получение списка мест пользователя',
    summary: 'Получение списка мест пользователя',
    security: [['bearerAuth' => '{}']],
    tags: ['Unions (User)']
)]
#[OA\Parameter(
...
final readonly class GetByUserIdAction implements RequestHandlerInterface
{
    public function __construct(
        ...
        private PlaceGetByUserIdFetcher $fetcher,
