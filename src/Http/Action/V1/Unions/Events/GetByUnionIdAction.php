...
use App\Modules\Union\Query\Event\GetByUnionId\EventGetByUnionIdFetcher;
use App\Modules\Union\Query\Event\GetByUnionId\EventGetByUnionIdQuery;
...
#[OA\Get(
    ...
    description: 'Получение списка событий места',
    summary: 'Получение списка событий места',
    security: [['bearerAuth' => '{}']],
    tags: ['Places']
)]
#[OA\Parameter(
...
final readonly class GetByUnionIdAction implements RequestHandlerInterface
{
    public function __construct(
        private Denormalizer $denormalizer,
        private EventGetByUnionIdFetcher $fetcher,
