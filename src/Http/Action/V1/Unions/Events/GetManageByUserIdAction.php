...
use App\Modules\Union\Query\Event\GetManageByUserId\EventGetManageByUserIdFetcher;
use App\Modules\Union\Query\Event\GetManageByUserId\EventGetManageByUserIdQuery;
...
#[OA\Get(
    path: '/users/{id}/events/manage',
    description: 'Получение списка администрируемых событий пользователя',
    summary: 'Получение списка администрируемых событий пользователя',
    security: [['bearerAuth' => '{}']],
    tags: ['Unions (User)']
)]
#[OA\Parameter(
...
final readonly class GetManageByUserIdAction implements RequestHandlerInterface
{
    public function __construct(
        ...
        private EventGetManageByUserIdFetcher $fetcher,
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $query = $this->denormalizer->denormalizeQuery(
            ...
            EventGetManageByUserIdQuery::class
        );
