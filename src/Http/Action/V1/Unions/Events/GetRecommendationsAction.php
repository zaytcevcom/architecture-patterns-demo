...
use App\Modules\Union\Query\Event\GetRecommendation\EventGetRecommendationFetcher;
use App\Modules\Union\Query\Event\GetRecommendation\EventGetRecommendationQuery;
...
#[OA\Get(
    ...
    description: 'Рекомендуемые события',
    summary: 'Рекомендуемые события',
    security: [['bearerAuth' => '{}']],
    tags: ['Events']
)]
#[OA\Parameter(
...
final readonly class GetRecommendationsAction implements RequestHandlerInterface
{
    public function __construct(
        ...
        private EventGetRecommendationFetcher $fetcher,
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $query = $this->denormalizer->denormalizeQuery(
            ...
            type: EventGetRecommendationQuery::class
        );
