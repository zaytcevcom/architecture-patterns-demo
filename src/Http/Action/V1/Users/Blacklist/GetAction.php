...
use App\Modules\Contact\Query\Blacklist\Get\ContactGetBlacklistFetcher;
use App\Modules\Contact\Query\Blacklist\Get\ContactGetBlacklistQuery;
...
#[OA\Get(
    ...
    summary: 'Возвращает список заблокированных пользователей',
    security: [['bearerAuth' => '{}']],
...
final readonly class GetAction implements RequestHandlerInterface
{
    public function __construct(
        ...
        private ContactGetBlacklistFetcher $fetcher,
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $query = $this->denormalizer->denormalizeQuery(
            ...
            ContactGetBlacklistQuery::class
        );
