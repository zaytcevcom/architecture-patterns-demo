...
use App\Modules\Post\Command\Post\PhotoSave\PostPhotoSaveCommand;
use App\Modules\Post\Command\Post\PhotoSave\PostPhotoSaveHandler;
...
#[OA\Post(
    path: '/posts/photos',
    description: 'Сохранение загруженной фотографии для записи',
    summary: 'Сохранение загруженной фотографии для записи',
    security: [['bearerAuth' => '{}']],
...
final readonly class SavePhotoAction implements RequestHandlerInterface
{
    public function __construct(
        ...
        private PostPhotoSaveHandler $handler,
